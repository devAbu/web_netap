    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="50">
        <div class="container">
            <div class="navbar-translate">
                <a class="navbar-brand" href="http://demos.creative-tim.com/ui-kit/index.html" rel="tooltip" title="Designed by Invision. Coded by Creative Tim" data-placement="bottom" target="_blank">
                    Netap
                </a>
            </div>
        ...
        <div class="section">
            <div class="container">
                ...
                <div class="button-container" style="margin-top: 0;">
                    <a href="#" data-toggle="modal" data-target="#msgModal" class="btn btn-primary btn-round btn-lg">Message</a>
                </div>
            </div>
        </div>
            ...
            <div class="modal fade" id="msgModal" tabindex="-1" role="dialog" aria-labelledby="msgModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default btn-simple" data-dismiss="modal">Discard</button>
                            <button type="button" class="btn btn-info btn-simple">Send</button>
                        </div>
                    </div>
                </div>
            </div> <!-- Modal end -->

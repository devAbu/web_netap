        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation" data-nav-image="../assets/img/blurred-image-1.jpg">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="https://github.com/creativetimofficial/ui-kit/issues">Have an issue?</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="container">
                <nav>
                    <ul>
                        ...
                        <li>
                            <a href="https://github.com/creativetimofficial/ui-kit/blob/master/LICENSE.md">
                                MIT License
                            </a>
                        </li>
                    </ul>
